...
import retrofit2.Response;
    ...
    public class AddDiaryActivity extends AppCompatActivity {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            */
/* date calender 구현해서 선택 --> String변환하기*//*
...
/* feeling --> 선택해서 집어넣기 *//*
            ...
            diaryCancle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(AddDiaryActivity.this, "일기 작성이 취소되었습니다.", Toast.LENGTH_SHORT).show();
                    finish(); //Go Home
                }
            });
        }
            ...
            service.insertDiary(data).enqueue(new Callback<DiaryAddResponse>()  {
                ...
                public void onResponse(Call<DiaryAddResponse> call, Response<DiaryAddResponse> response) {
                    ...
                    if (result.getCode() == 200) {
                        Toast.makeText(AddDiaryActivity.this, result.getMessage(), Toast.LENGTH_SHORT).show();

                        //Intent intent = new Intent(AddDiaryActivity.this, JoinCompleteActicity.class);

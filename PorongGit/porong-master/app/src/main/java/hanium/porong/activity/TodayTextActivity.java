...
public class TodayTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_todaytext);
        final TextView tv = (TextView) findViewById(R.id.todayText);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TodayTextActivity.this, MainActivity.class);

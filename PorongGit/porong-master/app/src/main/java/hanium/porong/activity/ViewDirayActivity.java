    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv_goList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("title", view_title.getText().toString());
                intent.putExtra("content", view_content.getText().toString());
                intent.putExtra("feeling", view_feeling.getText().toString());
                intent.putExtra("diaryDate", view_date.getText().toString());
